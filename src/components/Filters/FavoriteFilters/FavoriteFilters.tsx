...
import { ClearItemsButton, FavoriteItemsCount, FilterButton, FilterFavoriteContainer, TypeFiltersContainer } from 'pages/Favorites/Favorites.styled';
...
export function FavoriteFilters({actualFilters, handleActualFilters, handleSelectFilters} : FavoriteFiltersProps) {
