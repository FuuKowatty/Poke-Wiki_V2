...
export const BannerContainer = styled.div`
    ...
    background: -webkit-linear-gradient(45deg, #003367,#123049);/* Chrome 10-25, Safari 5.1-6 */                          background: linear-gradient(45deg, #003367,#123049);/* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */                                             ;
